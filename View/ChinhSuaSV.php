...
<div class="col-md-10 d-flex flex-column align-items-center">
    <h2 class="text-center mt-4 mb-4"><b>CHỈNH SỬA THÔNG TIN SINH VIÊN</b></h2>
    <div class="content col-md-8">
        <form id="studentForm" action="" method="" name="formEdit" class="form-container">
            ...
            <div class="d-flex justify-content-end gap-4">
                ...
                <button type="submit" id="submitButton" class="button-me btn btn-warning fw-bold text-dark">Lưu</button>
            </div>
        </form>
    </div>
</div>
